...
export function HeroSection() {
  return (
    <section id="hero" className="relative pt-16 pb-12 overflow-hidden bg-white">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.9fr]">
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div className="space-y-4 text-lg leading-8 text-gray-700">
              ...
              <p className="text-base text-gray-700">{heroData.description}</p>
            </div>
            ...
            <div className="flex flex-col gap-4 pt-8 sm:flex-row">
              {heroData.stats.map((stat, idx) => {
                ...
                return (
                  <div key={idx} className="flex items-center gap-4 rounded-lg border border-gray-200 bg-white px-4 py-3">
          ...
          <div className="flex items-center justify-center">
            <Image
              src="/assests/images/hero_Image.png"
              alt="Hero Image"
              width={400}
              height={500}
